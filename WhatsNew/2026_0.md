...
* Injection of the results in the structure studies

>Python improvement

* Faster execution for non virtual environment scripts
* Hierarchy tree for better organization of the scripts
* New right tab for python scripts in piping, structure, review, load and analysis screens
